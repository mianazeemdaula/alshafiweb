                    ...
                    <div class="bg-red-600 shadow rounded-lg p-4 mb-4">
                        <div class="flex flex-col space-y-4">
                            <div class="flex items-center space-x-4">
                                <img class="h-20 w-20 rounded-full object-cover" src="{{ $item->user->avatar }}"
                                    alt="{{ $item->user->name }}" />
                                <div>
                            ...
                            <div>
                                <div class="text-sm font-medium text-gray-900">Payment:
                                    {{ $item->paymentMethod->name ?? '' }}</div>
                                <div class="text-sm text-gray-700">Status: <span
                                ...
                                <div class="text-sm text-gray-700">City/Zip: {{ $item->city->name }} ({{ $item->zip_code }})
                                </div>
                            ...
                            <div class="flex space-x-2">
                                ...
                                <a href="#" aria-label="Delete Order {{ $item->id }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" strokeWidth="1" class="w-5 h-5">
