            ...
            <div class="overflow-hidden border border-gray-200 md:rounded-lg">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-700 flex just items-center">
                            <a href="{{ route('admin.orders.show', $item->id) }}" class="text-gray-700 hover:text-blue-500">
