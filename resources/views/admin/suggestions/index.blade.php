...
<section class="mx-auto w-full max-w-7xl px-4 py-4">
    ...
    <div class="flex flex-col space-y-2 md:flex-row md:items-center md:justify-between md:space-y-0">
        ...
        <div>
            <a href="{{ route('admin.suggestions.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Add New
            </a>
        </div>
    </div>
    ...
    <x-pagging :paginator=$suggestions />
</section>
@endsection
