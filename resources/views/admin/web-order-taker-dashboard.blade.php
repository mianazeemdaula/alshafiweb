...
@section('content')
    <!-- Modern Web Order Taker Dashboard -->
    <div class="p-4 lg:p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">

        <!-- Header -->
        <div class="mb-6">
            <div class="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 rounded-2xl p-6 shadow-xl">
                <div class="flex items-center justify-between">
                    <div class="text-white">
                        <h1 class="text-3xl font-bold mb-2">🌐 Website Orders Dashboard</h1>
                        <p class="text-white/90">Welcome back, {{ auth()->user()->name }}!</p>
                        <p class="text-white/80 text-sm mt-1">Manage all website orders and shipments</p>
                    </div>
                    <div class="hidden md:block">
                        <div class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                            <i class="fa fa-globe text-4xl text-white"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
                ...
                <!-- Today Orders -->
                <div
                    class="bg-gradient-to-br from-cyan-500 to-teal-500 rounded-xl p-5 shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
                    <div class="flex items-center justify-between mb-2">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center">
                            <i class="fa fa-calendar-day text-2xl text-white"></i>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-medium mb-1">Today</h3>
                    <p class="text-3xl font-bold text-white">{{ $stats['today_orders'] }}</p>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center">
                            <i class="fa fa-calendar-week text-2xl text-white"></i>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-medium mb-1">This Week</h3>
                    <p class="text-3xl font-bold text-white">{{ $stats['week_orders'] }}</p>
                </div>

                <!-- Month Orders -->
                <div
                    class="bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl p-5 shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
                    <div class="flex items-center justify-between mb-2">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center">
                    ...
                    <h3 class="text-white/90 text-sm font-medium mb-1">This Month</h3>
                    <p class="text-3xl font-bold text-white">{{ $stats['month_orders'] }}</p>
                </div>
                ...
                <div class="space-y-3">
                    <a href="{{ route('admin.orders.index') }}"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 dark:text-white">View All Website Orders</p>
                                <p class="text-xs text-gray-600 dark:text-gray-400">Manage website orders</p>
                            </div>
                        </div>
                    ...
                    <a href="{{ route('admin.shipments.index') }}"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 dark:text-white">Manage Shipments</p>
                                <p class="text-xs text-gray-600 dark:text-gray-400">Create & track shipments</p>
                            </div>
                        </div>
                        <i class="fa fa-chevron-right text-gray-400 group-hover:translate-x-1 transition-transform"></i>
                    </a>
                    ...
                    <a href="{{ route('admin.orders.index', ['status' => 'delivered']) }}"
                        class="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 rounded-lg hover:shadow-md transition-all group">
                        <div class="flex items-center gap-3">
                            <div
                            ...
                            <div>
                                <p class="font-medium text-gray-900 dark:text-white">Delivered Orders</p>
                                <p class="text-xs text-gray-600 dark:text-gray-400">{{ $stats['delivered_orders'] }}
                                    completed</p>
                            </div>
                        </div>
                        <i class="fa fa-chevron-right text-gray-400 group-hover:translate-x-1 transition-transform"></i>
