...
<body>
    <div class="bg-gray-100 min-h-screen flex">
        <!-- Sidebar -->
        <div id="sidebar"
            class="fixed lg:relative z-30 top-0 left-0 min-h-screen h-full bg-gray-800 text-white w-64 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col">
